...
const TeacherRegistration: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            setLoading(true);
            const response = await axios.post('http://localhost:5037/api/TeacherRegistration/teacherRegistration', formData);
    ...
    return (
        <Container className="container">
            <h1 className="text-center mt-4 mb-3">Teacher Registration</h1>
